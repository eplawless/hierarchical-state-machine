...
var fsmFactory = new StateMachineFactory({
    ...
    states: {
        state1: {
            deferEvents: ['event1'],
            eventTransitions: { event2: 'state2' }
        },
        state2: {
            deferEvents: ['event1'],
            eventTransitions: { event2: 'state3' },
        },
        state3: { eventTransitions: { event1: 'state4' }, },
        state4: { eventTransitions: { event1: 'state5' }, },
        state5: { eventTransitions: { event1: 'state6' }, },
        state6: {}
    }
});
